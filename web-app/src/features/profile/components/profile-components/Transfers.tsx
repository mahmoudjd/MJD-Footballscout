        ...
        {transfers.map((t, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 rounded-2xl border border-stone-200 bg-white p-4 shadow-[0_12px_24px_-22px_rgba(15,23,42,0.45)]">
                <div className="flex items-center gap-2 text-sm text-slate-500">
                  <OutlineIcons.CalendarIcon className="h-5 w-5 text-amber-600" />
