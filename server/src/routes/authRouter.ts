...
import { AppContext, UserRegisterInput, UserLoginInput } from "../models/player";
...
export default function createAuthRouter(context: AppContext) {
    ...
    router.post("/register", async (req: Request, res: Response): Promise<any> => {
        try {
            const input: UserRegisterInput = registerSchema.parse(req.body);
    ...
    router.post("/login", async (req: Request, res: Response): Promise<any> => {
        try {
            const input: UserLoginInput = loginSchema.parse(req.body);
